...
public class DAG_Test {
	...
	@Test
	public void testLCACommonAncestors()
	{
		DAG graph = new DAG(10);
		graph.addEdge(0, 1);
		graph.addEdge(0, 3);
		...
		graph.addEdge(2, 5);
		//test LCA
		assertEquals(0, graph.findLowestCommonAncestor(2, 1));
		assertEquals(3, graph.findLowestCommonAncestor(2, 3));
		assertEquals(2, graph.findLowestCommonAncestor(4, 5));
		//Test vertex that aren't there
		assertEquals(-1, graph.findLowestCommonAncestor(8, 2));
		//tests -ve vertex
		assertEquals(-1, graph.findLowestCommonAncestor(-2, 3));
		assertEquals(-1, graph.findLowestCommonAncestor(3, -2));
		assertEquals(-1, graph.findLowestCommonAncestor(-2, -3));
	...
	public void testLCASameVertex()
	{
		...
		assertEquals(3, graph.findLowestCommonAncestor(3, 3));
	}
}
